...
/**
 * Class m250130_111535_update_concursos_20250130
 */
class m250130_111535_update_concursos_20250130 extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        $numeroExpediente = 'EX-2024-04931107-   -UBA-DMESA#FCEN';
        $concurso = (new \yii\db\Query())
            ->select(['id_concurso'])
            ->from('concurso')
            ->where(['numero_expediente' => $numeroExpediente])
    ...
    {
        echo "m250130_111535_update_concursos_20250130 cannot be reverted.\n";
        return false;
    }
