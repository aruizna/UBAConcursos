...
<div class="profile-index">
                    ...
                    <?php if (isset($cid) && $cid != '0') : ?>
                        <div style="display:flex;flex-direction:column;align-items: start;justify-content: center;">
                            ...
                            <div class="mb-2" style="display:flex;flex-direction:row">
                                ...
                                <div class="ml-2" style="display:flex;align-items: center;">
                                    <p class="concurso_data"><?php try {
                                                                    echo (TipoConcurso::find()->where(['id_tipo_concurso' => $concurso->id_tipo_concurso])->one()->descripcion_tipo_concurso);
                                                                } catch (\Throwable $e) {
                                                                    echo ('');
                                                                } ?></p>
                                </div>
                            ...
                            <div class="mb-2" style="display:flex;flex-direction:row">
                                ...
                                <div class="ml-2" style="display:flex;align-items: center;">
                                    <p class="concurso_data"><?php try {
                                                                    echo (Facultad::find()->where(['id_facultad' => $concurso->id_facultad])->one()->nombre_facultad);
                                                                } catch (\Throwable $e) {
                                                                    echo ('');
                                                                } ?></p>
                                </div>
                            ...
                            <div class="mb-2" style="display:flex;flex-direction:row">
                                ...
                                <div class="ml-2" style="display:flex;align-items: center;">
                                    <p class="concurso_data"><?php try {
                                                                    echo (AreaDepartamento::find()->where(['id_area_departamento' => $concurso->id_area_departamento])->andWhere(['id_facultad' => $concurso->id_facultad])->one()->descripcion_area_departamento);
                                                                } catch (\Throwable $e) {
                                                                    echo ('');
                                                                } ?></p>
                                </div>
                            ...
                            <div class="mb-2" style="display:flex;flex-direction:row">
                                ...
                                <div class="ml-2" style="display:flex;align-items: center;max-width:700px">
                                    <p class="concurso_data"> <?php try {
                                                                    echo (Categoria::find()->where(['id_categoria' => $concurso->id_categoria])->one()->descripcion_categoria);
                                                                } catch (\Throwable $e) {
                                                                    echo ('');
                                                                } ?></p>
                                </div>
                            ...
                            <div class="mb-2" style="display:flex;flex-direction:row">
                                ...
                                <div class="ml-2" style="display:flex;align-items: center;max-width:700px">
                                    <p class="concurso_data"> <?php try {
                                                                    echo (Dedicacion::find()->where(['id_dedicacion' => $concurso->id_dedicacion])->one()->descripcion_dedicacion);
                                                                } catch (\Throwable $e) {
                                                                    echo ('');
                                                                } ?></p>
                                </div>
                ...
                <div class="card-body">
                        ...
                        <div class="content" style="max-height: max-content;">
                            <div class="my-4">
                                ...
                                <div>
                                    <div style="display:flex;flex-direction:row">
                                        <div style="width:250px;display:flex;align-items: center;">
                                            <p class="my-0">
                                            <p class="my-0"><span class="obligatorio">*</span>Estado civil</p>
                                        </div>
                                        <div class="ml-2" style="display:flex;align-items: center;">
                                            <?=
                            ...
                            <div>
                                <div class="ml-4" style="display:flex;flex-direction:row">
                                    <div style="width:250px;display:flex;align-items: center;">
                                        <p class="my-0">
                                        <p class="my-0"><span class="obligatorio">*</span>Localidad</p>
                                    </div>
                                    ...
                                    <div class="mx-4" style="width:250px;display:flex;align-items: center;justify-content:center;max-width:max-content">
                                        <p class="my-0">
                                        <p class="my-0"><span class="obligatorio">*</span>Fecha de Nacimiento</p>
                                    </div>
                                    <div style="display:flex;align-items: center;">
                                        ...
                                        <?= $form->field($dataProvider, 'nacimiento_fecha')->widget(DatePicker::class, [
                                            ...
                                            'pluginOptions' => [
                                                ...
                                                'format' => 'dd-mm-yyyy',
                                                'todayHighlight' => true,
                                                "endDate" => (new Datetime())->sub(new DateInterval('P18Y'))->format('d-M-Y'),
                                                "startDate" => (new Datetime())->sub(new DateInterval('P65Y'))->format('d-M-Y'),
                                ...
                                <div class="mt-2" style="display:flex;flex-direction:row">
                                    <div style="width:250px;display:flex;align-items: center;">
                                        <p class="my-0">
                                        <p class="my-0"><span class="obligatorio">*</span>Provincia</p>
                                    </div>
                            ...
                            <H5 class="mt-4 mb-2">
                                <p class="my-0">Domicilio
                            </H5>
                            <div>
                                <div class="ml-4" style="display:flex;flex-direction:row">
                                    <div style="width:250px;display:flex;align-items: center;">
                                        <p class="my-0">
                                        <p class="my-0"><span class="obligatorio">*</span>Calle</p>
                                    </div>
                                    <div class="mt-2" style="display:flex;align-items: center;">
                                        <?=
                                        $form->field(
                                    ...
                                    <div class="mx-4" style="width:250px;display:flex;align-items: center;justify-content:center;max-width:max-content">
                                        <p class="my-0">
                                        <p class="my-0"><span class="obligatorio">*</span>Nº</p>
                                    </div>
                                    <div style="display:flex;align-items: center;">
                                        <?=
                                        $form->field(
                                ...
                                <div class="mt-2" style="display:flex;flex-direction:row">
                                    ...
                                    <div class="mx-4" style="width:250px;display:flex;align-items: center;justify-content:center;max-width:max-content">
                                        <p class="my-0">
                                        <p class="my-0"><span class="obligatorio">*</span>CP</p>
                                    </div>
                                    <div style="display:flex;align-items: center;">
                                        <?=
                                        $form->field(
                    ...
                    <div id="divcargos" class="content">
                        <div class="my-4">
                            <div>
                                <H5 class="mt-4 mb-4">
                                    <p class="my-0">Cargos Docentes Actuales
                                </H5>
                                    ...
                                    <div class="row mb-4" style="justify-content:center">
                                        <table style="max-width:90%">
                                            ...
                                            <tbody id="cargosactuales">
                                                <?php
                                                foreach ($dataProvider->cargosActuales as $cargoactual) :
                                                    echo ('<tr>' .
    ...
    <?= $form->field($dataProvider, 'user_id')->hiddenInput()->label(false) ?>
    <?= $form->field($dataProvider, 'id')->hiddenInput()->label(false) ?>
    <div class="mt-2">
        <?php if (isset($cid) && $cid != '0') : ?>
            <?= $form->field($dataProvider, 'concurso_id')->hiddenInput(['value' => $cid])->label(false) ?>
